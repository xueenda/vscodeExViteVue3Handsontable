...
export class WebAppPanel {
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        const scriptUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "dist-web", "assets/app.js")
        );
        const styleeUri = webview.asWebviewUri(
            vscode.Uri.joinPath(this._extensionUri, "dist-web", "assets/style.css")
        );
        ...
        return `      
                ...
                <head>
                    ...
                    <link href="${styleeUri}" rel="stylesheet">
                    <title>Web App Panel</title>
                </head>
                <body>
                <input hidden data-uri="${baseUri}" style="display: none;">
                    <div id="app"></div>  
                </body>
                </html> 
            `;
